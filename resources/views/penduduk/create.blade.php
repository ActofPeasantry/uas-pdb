...
<div class="container-fluid">
    <div class="panel">
        ...
        <div class="panel-body">
            <form class="post" action="{{route('penduduk.store')}}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="nik" name="nik" class='form-control' value="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="ayah" name="ayah" class='form-control' value="">
                </div>

                <div class="form-group">
                    <label class="form-label" for="no">Nama Ibu</label>
                    <input type="text" id="ibu" name="ibu" class='form-control' value="">
                </div>
